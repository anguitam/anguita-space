...
export const venture = [
  ...
  {
    role: "Founder",
    org: "Sara Grow Lights",
    when: "2018 — 2019",
    note: "I built a grow-light system that reproduced sunlight at any latitude, so a plant could be given the sky it evolved to grow under rather than a generic store-bought spectrum. It taught me about design, and mostly that perfect is the enemy of 'good enough.'",
  },
];
...
export const education = [
  {
    ...
    major: "BE Mechanical Engineering and Control Theory (Mechatronics)",
    year: "2018",
    note: "",
  },
  {
